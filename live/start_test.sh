...
echo -e "  Tek tick  : python live/live_runner.py"
echo -e "  15dk döngü: python live/live_runner.py --loop 900"
echo -e "  Screen    : screen -S livebot python live/live_runner.py --loop 900"
